...
const Appeals = () => {
    ...
    const appeals = [
        ...projects.filter((project) => project.to === null || project.to === undefined),
    ...
    return (
        <section className="py-12 font-raleway">
            <div className="container mx-auto" data-aos="fade-up">
                <h2 className="text-5xl font-semibold text-indigo-950 mb-10 text-center font-raleway custom-underline">Our Appeals</h2>
